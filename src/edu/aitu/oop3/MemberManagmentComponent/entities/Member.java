package edu.aitu.oop3.MemberManagmentComponent.entities;
...
public class Member {
    ...
    private Member(Builder b) {
        ...
        this.name = b.name;
        this.email = b.email;
        this.membershipTypeId = b.membershipTypeId;
        this.membershipStart = b.membershipStart;
    ...
    public static class Builder {
        ...
        public Builder membershipStart(String membershipStart) {
            this.membershipStart = membershipStart;
            return this;
        }

        public Builder membershipEnd(String membershipEnd) {
            this.membershipEnd = membershipEnd;
            return this;
        }
